    ...
    return (
        ...
        <div className='super-box' style={{ backgroundColor: "lightgray", height: "100vh",  display: "flex" }}>
            ...
            <Navbar sticky="top" collapseOnSelect expand="lg" variant="light" style={{ backgroundColor: "hsla(155, 83%, 24%, 1)", height: "70px" }}>
                    ...
                    <Navbar.Brand href="#home" style={{ marginLeft: "1vw", color: "white" }}><h6 style={{ fontSize: "17px" }}> <FaUnity/> &nbsp; Analytics
                    </h6></Navbar.Brand>
            ...
            <h4 className='container' style={{display:"flex",justifyContent:"center",alignItems:"center",height:"80vh"}}>Hola Analytics ! </h4>
