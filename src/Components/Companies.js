...
function Companies() {
    ...
    document.title = 'Conpanies : hello'

    return (

        <div className='super-box' style={{ backgroundColor: "lightgray", height: "150vh", display: "flex" }}>
            ...
            <div className='right-beta' style={{ backgroundColor: "lightgray", height: "100vh", width: "95vw" }}>
                ...
                <Navbar sticky="top" collapseOnSelect expand="lg" variant="light" style={{ backgroundColor: "hsla(155, 83%, 24%, 1)", height: "70px" }}>
                    ...
                    <Navbar.Brand href="#home" style={{ marginLeft: "1vw", color: "white" }}><h6 style={{ fontSize: "15px" }}>  &nbsp; All Companies
                    </h6></Navbar.Brand>
                ...
                <div style={{ display: "flex", height: "100vh", backgroundColor: "white", margin: "2vw" }}>
                ...
                <Table striped bordered hover >
                    ...
                    <tbody>
                        <tr>
                           ...
                           <Form.Check type="checkbox" label='Acme Inc.' />
                           </Form.Group></td>
                        ...
                        <tr>
                            <td ><Form.Group controlId="formBasicCheckbox">
                           <Form.Check type="checkbox" label='Ldke Inc.' />
                           </Form.Group></td>
