...
import { FcBusinessman, FcFrame, FcBusinessContact, FcTreeStructure, FcViewDetails, FcSms, FcPositiveDynamic, FcAutomatic} from "react-icons/fc"
        ...
        <div className='super-box' style={{ backgroundColor: "lightgray", height: "120vh", display: "flex" }}>
            ...
            <div className='right-beta' style={{ backgroundColor: "lightgray", height: "120vh", width: "95vw" }}>
                ...
                <Navbar sticky="top" collapseOnSelect expand="lg" variant="light" style={{ backgroundColor: "hsla(155, 83%, 24%, 1)", height: "70px" }}>
                    ...
                    <Navbar.Brand href="#home" style={{ marginLeft: "1vw", color: "white" }}><h6 style={{ fontSize: "15px" }}> Knowledge base
                    </h6></Navbar.Brand>
                ...
                <div style={{ backgroundColor: "white", height: "100vh", margin: "3vh", borderRadius: "7px" }}>
                    &nbsp;

                    <h6 style={{ marginLeft: "5vw" }}>Category(1)</h6>
                    &nbsp;
                    ...
                    <Card.Body>
                        <Card.Title>General </Card.Title>
                          &nbsp;
                              ...
                              <Card.Text>
                             <pre style={{fontsize:"34px "}}> Faq                         01</pre>
                             &nbsp;
                             &nbsp;

                             <pre style={{fontsize:"34px "}}> Getting Started             01</pre>
                              </Card.Text>
                     </Card.Body>
                 </Card> */}

                    <div style={{ height: "195px", width: "225px", backgroundColor: "white", marginLeft: "5vw", border: "1px solid black", borderRadius: "10px" }}>
                        &nbsp;
                        <h6 style={{ marginLeft: "3vw" }}>General</h6>

                        <pre style={{ fontSize: "16px" }}> Faq               01</pre>
                        <pre style={{ fontSize: "16px" }}> Getting Started   01</pre>
